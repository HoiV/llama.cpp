...
//  std::string model_path             = "./Phi-3-mini-4k-instruct-Q4_K_M-LMStudio.gguf"; // model path
	std::string model_path             = "./Phi-3-mini-4k-instruct-Q4_0-MS.gguf"; // model path
//	std::string model_path             = "./Phi-3-mini-4k-instruct-Q2_K-MS.gguf"; // model path
    std::string prompt                 = "";
    std::string custom_p_file          = "bZM_v2.txt"; // custom prompts input file
    std::string custom_template_prompt = "";
    std::string pfx_shared             = "";    // shared prompt for prefix cache (or prompt cache)
    std::string pfx_file               = "./bZM_v2_cache-Q8_0.zbin"; // file name for prefix cache
