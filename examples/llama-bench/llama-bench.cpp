...
int main(int argc, char ** argv) {
    ...
    for (const auto & inst : params_instances) {
        ...
        if (t.n_prompt > 0) {
            ...
            xb_set_process_affinity(t.n_threads_prompt, affinity_mask);
            // printf("llb - %08X: ", (uint32_t)affinity_mask);
